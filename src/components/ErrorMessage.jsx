...
function ErrorMessage({message, onRetry}) {
  return (
    <div className='bg-red-500 backdrop-blur-xl border border-red-400/20 rounded-3xl p-8 shadow-2xl'>
      ...
      {onRetry && (
        <button className='flex items-center space-x-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-2xl px-6 py-3 text-white transition-all duration-300 
